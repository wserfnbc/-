...
$(function () {
    ...
    $.fn.uploadOneImage = function () {
        return this.each(function () {
            ...
            console.log($in)
            $bt.attr('data-size', $in.data('size') || 0).attr('data-type', $in.data('type') || 'png,jpg,gif,jpeg,svg').find('span').on('click', function (event) {
    ...
    $.fn.uploadMultipleImage = function () {
        return this.each(function () {
            ...
            $in.after($bt.attr('data-size', $in.data('size') || 0).attr('data-type', $in.data('type') || 'png,jpg,gif,jpeg,svg').uploadFile(function (src) {
